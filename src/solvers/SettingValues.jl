...
function _update_Interpolant(D::DataMultiBlock{TT,DIM,NB,DATABLOCK,ParallelData{TT,DIM,TPARALLELGRID,TMAGNETICFIELD,TINTERPOLANT,TINTERCEPT}}) where {TT,DIM,NB,DATABLOCK,TPARALLELGRID,TMAGNETICFIELD,TINTERPOLANT,TINTERCEPT}
    _update_Interpolant(D[1], D[1].Parallel.Interpolant,Val(:chs))
end
